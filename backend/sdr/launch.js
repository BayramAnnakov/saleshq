...
// Start the server
server.start();
console.log("A2A Server started on port 3002");
console.log("Try connecting with an A2A client:");
console.log("  A2A Endpoint: http://localhost:3002/api");
console.log("  Agent Card: http://localhost:3002/.well-known/agent.json"); 